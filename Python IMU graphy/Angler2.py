...
# def angle_calc(sensor_id, measurement):
    ...
    #
    # angle_x = np.cumsum(measurement[3])/60
    # angle_x = integrate.cumtrapz(measurement[3], )
    # angle_y = np.cumsum(measurement[4])/60
    # angle_z = np.cumsum(measurement[5])/60
    #
    #
    # initial_x_angle = math.atan(acc_x / math.sqrt(acc_y ** 2 + acc_z ** 2))
    # initial_y_angle = math.atan(acc_y / math.sqrt(acc_x ** 2 + acc_z ** 2))
    # degrees_x = (180/math.pi) * initial_x_angle
    # average_angle = []
    #
    ...
    #
    # ys[sensor_id][6].append(initial_x_angle)
    #
    # ys[sensor_id][6].append(angle_x)
    #
    # print(average)
